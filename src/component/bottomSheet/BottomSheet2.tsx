...
const BottomSheet2: React.FC<BottomSheetProps> = ({
  isOpen,
  setIsOpen,
  children,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-[1000] bg-white shadow-lg sm:rounded-t-2xl rounded-tl-[20px] rounded-tr-[20px] max-h-[35%] w-full overflow-hidden ">
        {/* <div
