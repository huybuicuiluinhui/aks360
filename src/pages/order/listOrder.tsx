            ...
            return (
              <div className="mt-4 px-3" key={index}>
                <div className="flex items-center justify-between mb-[1px]">
                  <p className="text-[#0A9391] text-[13px] ">MÃ ĐƠN HÀNG</p>
                  {item.money_use_code !== 0 && (
                    <p className="text-xs  line-through text-[#333333] font-medium text-right ">
                ...
                <div className="flex items-center justify-between mb-[1px]">
                  ...
                  {item.money_use_code !== 0 ? (
                    <p className="text-xs   text-[#8C8C8C] font-medium">
                      -{formatNumber(item.money_use_code)} đ
                    </p>
                  ) : (
                    <p className="text-xs   text-[#D60013] font-medium text-right mb-2">
